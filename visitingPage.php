...
<head>
    ...
    <script>
        ...
        function toKids(){
            window.location.href="childrene.html";
        }
    </script>
    <style>

        body {background-color: khaki;background-image: url("images/o5.jpg") ;background-size:cover;height: 9vh;}

        .header{width: 100%;height: 70vh; position: fixed}
        .header .navbar {
            opacity: 100%;
            width: 100%;
            height: 60px;
...
<div class="header">
    ...
    <div class="navbar">
        ...
        <div class="navcont">
            <h2><a href="homePage.php">Home    </a><a href="mainlogin.php">login</a><a href="signUp.php" >|SignUp</a></h2>
        </div>
    ...
    <div class="photo">
        ...
        <div>
            ...
            <h2>you can't shopping without loging</h2>
            <input type="button" name="men" class="b1" onclick="toMen()">
            <input type="button" name="women" class="b2" onclick="toWomen()">
            <input type="button" name="children"  class="b3" onclick="toKids()">
